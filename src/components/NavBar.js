    ...
    <nav className="navbar navbar-expand-lg ">
        <div className="container nav_content">
            ...
            <div className='d-flex gap-1 align-items-center'>
                <div>
                    <a href=''>
                        <svg onClick={handelFav} width="23" height="23" className='fav' viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <a href=''><svg className='' onClick={handelCart} width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
