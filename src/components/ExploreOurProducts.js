...
function ExploreOurProducts(props){
    ...
    // }, [])
    // const thirdGroup = products.slice(8, 17)
    return(
        <>
            <div className="Slide2_item slide6_item col-sm-6 col-md-4 col-lg-3" key={props.id}>
                <div className="item_img   ">
                    <div className="item_img_content">
                        <p className="hide"></p>
                        <div className="item_img_icons">
                        <svg onClick={() => dispatch(addToFav(props))} width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
